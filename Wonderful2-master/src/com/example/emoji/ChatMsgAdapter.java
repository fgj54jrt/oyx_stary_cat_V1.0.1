		...
		if (convertView == null) {
			if (isComMsg) {
				convertView = mInflater.inflate(
						R.layout.emoji_chatting_item_msg_text_left, null);
			} else {
				convertView = mInflater.inflate(
						R.layout.emoji_chatting_item_msg_text_right, null);
			}
